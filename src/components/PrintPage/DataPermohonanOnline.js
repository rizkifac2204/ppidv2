...
export const DataPermohonanOnline = React.forwardRef(({ detail }, ref) => {
  return (
    <Card sx={{ display: "none", displayPrint: "block", p: 2 }} ref={ref}>
      <Box sx={{ display: "flex", flexWrap: "nowrap", p: 2, mb: 2 }}>
        ...
        <Box>
          ...
          <Typography>
            Jln. Sungai Moutong No. 8 Kota Palu, Provinsi Sulawesi Tengah 0813
            8819 6166
          </Typography>
        </Box>
      </Box>
        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableBody>
            ...
            <TableRow sx={{ border: 0 }}>
              <TableCell colSpan={2}>xxxxxxx, xx xx xxxx</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </TableContainer>
