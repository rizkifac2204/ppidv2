        ...
        <div className="background-top">
          <div className="item-title">
            <h2>
              ...
              <br />
              <span className="point">Formulir</span> Survey Pelayanan
            </h2>
            <p>
              Isi Formulir untuk melakukan Survey Pelayanan Informasi. Pelayanan
              Kantor pukul 08:00 AM s.d 16:00 PM.
            </p>
          </div>
          {/* .item-title */}
          ...
          <div className="first-block">
            <div className="container container-wide spec-sm">
              <div className="col-md-12">
                <h2>
                  <small>
                    Formulir Survey Pelayanan Informasi <br />
